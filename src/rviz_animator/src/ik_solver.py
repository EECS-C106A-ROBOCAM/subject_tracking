...
class IKSolver(object):
    """
    Path Planning Functionality for Baxter
    ...
    def get_ik_solution(self, target):
        """
        ...
        joint_angles = self._group.plan().joint_trajectory.points[-1].positions
        print(joint_angles)
    ...
    def go(self, target):
        ...
        Go to target pose.
        '''
        self._group.go(target, wait=True)